<?php
$trs = new lsp();
$dataTransaksi = $trs->querySelect("SELECT * FROM detailtransaksi WHERE status = 1");
if (isset($_GET['id'])) {
      $id = $_GET['id'];
                                          ...
                                          <div class="col-sm-12" style="padding: 50px;">
                                                ...
                                                <table class="table table-hover table-bordered" width="100%;" align="center">
                                                      ...
                                                      <tbody>
                                                            ...
                                                            <?php endforeach ?>
                                                            <?php
                                                            $grand = $trs->selectSum("detailtransaksi", "sub_total");
                                                            $grandM = $trs->selectSum("detailtransaksi", "sub_totalmodal");
                                                            ?>
                                                            <tr>
