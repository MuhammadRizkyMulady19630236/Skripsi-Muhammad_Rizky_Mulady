    ...
    <div class="col-sm-12">
      ...
      <p align="center"><b>
          <center>
            ...
            <font size="4"><b>Jalan IR. Pangeran Haji Muhammad Nur, Barabai, Kalimantan Selatan</b></font><br>
      ...
      <div class="row">
        <div class="col-sm-12" style="padding: 50px;">
          <p align="center"><b>
              <center>
                <font size="5">Data Semua Barang</font>
              </center>
            </b></p>
          <button class="btn" onclick="window.print()">Print</button><br><br><br>
          <table border="1" cellspacing="0" width="100%;" cellpadding="20">
            ...
            <tr>
              <td colspan="5">Total barang yang di miliki</td>
              <td>
                <?php echo $totbal['sum']; ?>
              </td>
            </tr>
