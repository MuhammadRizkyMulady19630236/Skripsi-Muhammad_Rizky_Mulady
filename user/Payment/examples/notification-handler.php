...
if ($transaction == 'settlement') {    
   include "koneksi.php";
   mysqli_query($koneksi,"update table_pretransaksi set status ='1' , transaction_id='$transaction_id' where kd_transaksi='$order_id'");    
} else if ($transaction == 'pending') {
       include "koneksi.php";
   mysqli_query($koneksi,"update table_pretransaksi set status ='0' where kd_transaksi='$order_id'");
 
} else if ($transaction == 'deny') {
      include "koneksi.php";
   mysqli_query($koneksi,"update table_pretransaksi set status ='5' where kd_transaksi='$order_id'");
